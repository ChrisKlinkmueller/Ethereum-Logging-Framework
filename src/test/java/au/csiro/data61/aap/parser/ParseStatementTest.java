...
public class ParseStatementTest {
    ...
    private static Stream<Arguments> validStatementSequence() {
        return Stream.of(
            Arguments.of("bytes8[] fKMbBaJ64H0 = {0xCadeb674DcFC8A65Dce3CF166cfD32F7e8dB1C84787F, 0xef816A460e66cbCA7FED0Be93227EaeAaB56f0ea01, 0xF0Ea49, 0x44Dcd17e64A86F1aAa8c6AbcaC9Da454};"),
			Arguments.of("bytes9 XXuSiXhgZS1 = 0x5f0c095b5be70F50cb1f49009f0cbEc7A5eaf7AA35dD5EE63dbA5e23;"),
			Arguments.of("address c0PtkBJwu22 = 0xA99BEAeedAeaff516C6cA546FeC386761A474f5f;"),
			Arguments.of("uint200[] hibHtHNZCK9:rgUGzqNP7Rm = {8432216569, 97447079969514, 597, 72, 946573079763477801, 105181268314813, 69923903690, 169748566};"),
			Arguments.of("bytes27 WAVHoj458WH = 0xE514EbebF1b3d4f394cd89a40b3Ce6;"),
			Arguments.of("int232 N3zWxJZuZHe:J1yrIbCnwQg = 7689097371;"),
			Arguments.of("ufixed8x12[] o8EA63GH9yu:NPItTfBtMLc = {631888440969200.73752, 8740.88487032, 84.3574395, 12191.8810269};"),
			Arguments.of("int184 wV4hGuwkgD3 = 13937981210647;"),
			Arguments.of("fixed24x1 EPZMthDm4OW = 137911.61726472;"),
			Arguments.of("ufixed72x19 dTHT1G5sc7i = 4148.4826;"),
			Arguments.of("bytes22 WfXXiya6wR3 = 0x3eaAb715ACBEca747Be8B0AB8Ad2FEF230D6;"),
			Arguments.of("bool aQ1L02HVEA8:eFh994NMDT3 = false;"),
			Arguments.of("bytes9 IFqjnJ5JWIW:KwWapKBwxaj = 0xDb4FE212d99dA52414F29d4d524C4Ca2CB52Ad3Ab4a9;"),
			Arguments.of("fixed40x65[] JnDRw43t2mO = {34026862384043791.91, 123.0119, 8758902137.5769116, 57819.8845514, 762720329669093397.7000203908, 9054.6, 65408454963345240.08};"),
			Arguments.of("bytes23 wAODjUppxuh:TxuHeI3kdvL = 0x0c2c1eFAbBCCa0b12EEFF49363E5eBa4B3;"),
			Arguments.of("bool G7tWZeViP3q = false;"),
			Arguments.of("string tCrMEh5DZv9 = \"ujj?Okz*U*9L#5(wOEf\";"),
			Arguments.of("fixed160x45[] aFTPwXhgQxC = {87.16, 32379537882124471.49055458, 8315.450350564, 5.46650175, 923063854519381995.6119, 8345406.26092371, 81128902, 58209288724.973};"),
			Arguments.of("bytes9[] l4tnxRxyx8f = {0x028eB86774Bf, 0x0E0bB4bDcEf1822dE10Be4, 0xea9494F6eFD5dA2feE, 0xbEebB5dF2bE2f182f3Fd9DeEbd94AeFfe4A1aB0dBd, 0x7e2cFA24BBCb, 0xEc769f34Fa34e81FdeC625a3D7eF317274e7ccC9CbAe2DfBF0, 0x5Cef8cA9AeC8bF14Cd4aADaf8CD2af8A4D0aAfc14caEFA8113Db};"),
			...
			Arguments.of("bytes22 bxsmWyugTLO = 0xFBed9A517Adb21b7DbBacFDf388ba7BB8C7cE45d;"),
			Arguments.of("bytes24[] isbnRMBb1vb = {0xdfD0a59AfeFE0CDA3477d5DbC54D5FB7A0f3650a4087bfE6E5, 0x8C2Ae92C5edaEd4F};"),
			Arguments.of("bool[] YBx9Zs0aCbw:STACqNE9gsM = {false, false, false, false, true, true, false, false, false, false};"),
			Arguments.of("uint48[] Pqlv10MmdiC:KI9C3kHcJHm = {9659741802, 0, 916268373486074847, 184296046};"),
			Arguments.of("string[] Je633BJiIY5:BAXm7XtS6Ay = {\"2*03APIo?(eOx#f(\", \"3M2mW*5^%yvZPYfVT\", \"g!BW1Bj:sRlLtGhMiC?wUdNk\"};"),
			Arguments.of("bytes24 rCunbuUc0Um = 0xddAbeFf2B7D7C1ac4AFa56B7AB;"),
			...
			Arguments.of("ufixed256x74 mVBAHtG2ubW = 50840565471663744.91456990;"),
			Arguments.of("string[] uhXBxZZibwX:O1VPkhRfWmb = {\"PY7JXLp:tTonddG6K08%\", \"N8fjjYRo2eiOr:y\", \"Q@&Y2\", \"9g5v^xP6ppIIlEnH13\"};"),
			Arguments.of("bytes10 wDxfMMRBb1S:uwqAugTS4VJ = 0xE1fd7b23AA3D101AE6dd3fb6fEA6C2;"),
			Arguments.of("string[] GWqU2xtVsQv = {\"pgQ6snxsk)rMpNhUjtv$bi\"};"),
			Arguments.of("string U8rSFCKXLqu:VMQsYgOgRCd = \"ygMxJrEqS6Qlm:KsuV\";"),
			Arguments.of("bytes30[] AfzcLJc8p5N:InBDrD9gvGi = {0x7EA4Cd8ADAa5ddA114Dee0511c977FCDfe2C306434DFe135d7FEddb06c, 0xecF5DfDaaa07FEf7E4ebaD9daFC0CB6bCF71d6f2a5B1086DA2d5c1DFf7bd, 0x97525BCbe3BdC9F9EC, 0xDA};"),
			Arguments.of("bytes23 G1sCZLeQUbV = 0x5AE02d9B4c4Af6cE54F9F788C7;"),
			...
			Arguments.of("int256[] Vf3J2t1qE0t = {3930880, 69122188345, 33457, 422, 399655011790, 8019152575057805, 76878, 3946, 962571600};"),
			...
			Arguments.of("ufixed96x23 BV5gh36B2kj:sU34FdNATeF = 35138297454.7301802890;"),
			Arguments.of("bytes20[] cFiWajYTHg9 = {0xCAccb7B9EbD4a0b3E281d69E9E153Bf4};"),
