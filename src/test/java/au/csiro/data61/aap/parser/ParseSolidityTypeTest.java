...
public class ParseSolidityTypeTest {
    ...
    void testValidNonconfigurableTypes(String keyword, String expectedClassName) {
        getType(keyword, true, expectedClassName);
    }
    ...
    void testValidNonconfigurableArrayTypes(String keyword, String expectedClassName) {
        final ArrayType type = (ArrayType)getType(keyword, true, ArrayType.class.getName());
        assertEquals(type.getBaseType().getClass().getName(), expectedClassName);
    }
    ...
    private void testBytesType(BytesType type, boolean isDynamic, int expectedLength) {
        assertTrue(isDynamic == type.isDynamic());
        if (!isDynamic) {
            assertEquals(expectedLength, type.getLength());
        }
    }
    ...
    SolidityType getType(String keyword, boolean isValidType, String expectedClassName) {
        ...
        if (isValidType) {
            assertTrue(result.getResult().getClass().getName().equals(expectedClassName));
