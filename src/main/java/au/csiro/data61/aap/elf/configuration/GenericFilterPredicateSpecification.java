...
public class GenericFilterPredicateSpecification {
    ...
    public static GenericFilterPredicateSpecification and(
        ...
        return new GenericFilterPredicateSpecification(
                state -> predicate1.test(state) && predicate2.test(state));
    }
    ...
    public static GenericFilterPredicateSpecification not(
            GenericFilterPredicateSpecification specification1) {
        final GenericFilterPredicate predicate1 = specification1.getPredicate();
        return new GenericFilterPredicateSpecification(state -> !predicate1.test(state));
    }

    public static GenericFilterPredicateSpecification ofBooleanAccessor(
            ValueAccessorSpecification valueSpecification) {
    ...
    public static GenericFilterPredicateSpecification equals(
        ...
        return ofEqualityCheck(valueSpecidication1, valueSpecidication2,
                (val1, val2) -> val1 != null && val1.equals(val2));
    }
    ...
    public static GenericFilterPredicateSpecification notEquals(
            ...
            ValueAccessorSpecification valueSpecidication2) {
        return ofEqualityCheck(valueSpecidication1, valueSpecidication2,
                (val1, val2) -> val1 == null ? val2 != null : !val1.equals(val2));
    }

    private static GenericFilterPredicateSpecification ofEqualityCheck(
            ValueAccessorSpecification valueSpecification1,
            ValueAccessorSpecification valueSpecification2, BiPredicate<Object, Object> predicate) {
    ...
    public static GenericFilterPredicateSpecification smallerThan(
            ValueAccessorSpecification accessor1, ValueAccessorSpecification accessor2) {
    ...
    private static GenericFilterPredicateSpecification ofIntegerComparison(
            ValueAccessorSpecification valueSpecification1,
            ValueAccessorSpecification valueSpecification2, IntPredicate comparator) {
        assert valueSpecification1 != null;
        assert valueSpecification2 != null;
        final ValueAccessor accessor1 = valueSpecification1.getValueAccessor();
        final ValueAccessor accessor2 = valueSpecification2.getValueAccessor();
        return new GenericFilterPredicateSpecification(state -> {
            ...
            if (value1 != null && !(value1 instanceof BigInteger)) {
                throw new ProgramException(
                        String.format("Value '%s' is not an BigInteger.", value1));
            }

            final Object value2 = accessor2.getValue(state);
            if (value2 != null && !(value2 instanceof BigInteger)) {
                throw new ProgramException(
                        String.format("Value '%s' is not an BigInteger.", value2));
            }

            return value1 != null && value2 != null
                    && comparator.test(((BigInteger) value1).compareTo((BigInteger) value2));
        });

    }

    public static GenericFilterPredicateSpecification in(ValueAccessorSpecification accessor1,
            ValueAccessorSpecification accessor2) {
        return new GenericFilterPredicateSpecification(
                createFilter(accessor2, accessor1, ListOperations::contains));
    }

    private static final GenericFilterPredicate createFilter(
            ValueAccessorSpecification specification1, ValueAccessorSpecification specification2,
            Method method) {
