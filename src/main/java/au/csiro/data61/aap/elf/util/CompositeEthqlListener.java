...
import au.csiro.data61.aap.elf.parsing.EthqlParser.ArrayValueContext;
...
import au.csiro.data61.aap.elf.parsing.EthqlParser.BooleanArrayValueContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.ByteAndAddressArrayValueContext;
...
import au.csiro.data61.aap.elf.parsing.EthqlParser.FixedArrayElementContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.FixedArrayValueContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.InstructionContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.IntArrayValueContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.LiteralContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.LiteralRuleContext;
...
import au.csiro.data61.aap.elf.parsing.EthqlParser.SkippableLogEntrySignatureContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.SmartContractSignatureContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.SmartContractVariableContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.SmartContractsFilterContext;
...
import au.csiro.data61.aap.elf.parsing.EthqlParser.StringArrayValueContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.TransactionFilterContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.ValueCreationContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.VariableContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.VariableDefinitionContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.VariableDefinitionRuleContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.VariableNameContext;
import au.csiro.data61.aap.elf.parsing.EthqlParser.VariableReferenceContext;
...
public class CompositeEthqlListener<T extends EthqlListener> implements EthqlListener {
    ...
    public void visitTerminal(TerminalNode node) {
        this.analyzers.forEach(l -> l.visitTerminal(node));
    }

    @Override
    public void visitErrorNode(ErrorNode node) {
        this.analyzers.forEach(l -> l.visitErrorNode(node));
    }
}